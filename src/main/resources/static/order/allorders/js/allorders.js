...
layui.use(['element', 'form', 'table', 'layer', 'laydate', 'tree', 'util'], function () {
    ...
    tableIns = table.render({
        ...
        , cols: [[
            ...
            , {field: 'garbageName', title: '垃圾名'}
            , {field: 'weight', title: '预约重量'}
            , {field: 'houseName', title: '小区名称'}
            ...
            , {field: 'rweight', title: '实际重量', hide: true}
            , {field: 'money', title: '交易金额', hide: true}
    ...
    table.on('toolbar(test)', function (obj) {
        switch (obj.event) {
            case 'receiveOrder':
                ...
                $.post(ctx + "/order/order/save", data, function (data) {
