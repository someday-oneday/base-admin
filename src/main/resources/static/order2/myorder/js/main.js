$(document).ready(function () {
    ...
    var cols = [
        ...
        {title: '联系电话', name: 'SECUCODE', align: 'center'},
        {title: '垃圾种类', name: 'SECUABBR', align: 'center'},
        {title: '预估重量', name: 'CLOSINGPRICE', align: 'center', renderer: fixed2},
        {title: '预约时间', name: 'DAYCHANGERATE', align: 'center', renderer: highliht},
        {title: '上门地址', name: 'DAYCHANGE', align: 'center', renderer: highliht},
        {title: '联系电话', name: 'AMPLITUDE', align: 'center', renderer: fixed2percentage},
        {
            title: '回收单位', name: 'TURNOVERVOL', align: 'center', renderer: function (val) {
                return (val / 100).toFixed(2);
            }
        },
        {
            title: '延时情况', name: 'TURNOVERVAL', align: 'center', renderer: function (val) {
                return (val / 10000).toFixed(2);
            }
        },
        {title: '状态', name: 'PREVCLOSINGPRICE', align: 'center'},
