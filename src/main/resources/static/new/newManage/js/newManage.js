...
layui.use(['element', 'form', 'table', 'layer', 'laydate', 'tree', 'util'], function () {
    ...
    tableIns = table.render({
        ...
        , title: '公告列表'
        , cols: [[
            {field: 'newId', title: '公告id', hide: true}
            , {field: 'newTitle', title: '标题'}
            , {field: 'newText', title: '内容', hide: true}
            , {field: 'newTime', title: '发布时间'}
    ...
    table.on('toolbar(test)', function (obj) {
        switch (obj.event) {
            ...
            case 'query':
                ...
                //设定异步数据接口的额外参数
                query.where = {newTitle: queryByGarbageName};
    ...
    table.on('tool(test)', function (obj) {
        ...
        if (obj.event === 'del') {
            layer.confirm('确认删除吗？', function (index) {
                //向服务端发送删除指令
                $.delete(ctx + "/info/infonews/delete/" + data.newId, {}, function (data) {
